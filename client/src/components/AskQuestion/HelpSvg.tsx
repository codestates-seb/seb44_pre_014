...
const HelpSvg = () => {
  const helpsvg =
    'M31.52 5.2a.34.34 0 0 0-.46.08L7 39.94a.34.34 0 0 0-.06.16l-.54 5.21c-.03.26.24.45.48.34l4.77-2.29c.05-.02.1-.06.13-.1L35.83 8.58a.34.34 0 0 0-.09-.47l-4.22-2.93Z';
  const helpsvg2 =
  ...
  return (
    <svg aria-hidden="true" width="48" height="48" viewBox="0 0 48 48">
      <path d={helpsvg} opacity=".2"></path>
      <path d={helpsvg2}></path>
    </svg>
  );
};
